...
export default function Home() {
  ...
  return (
    ...
    <div className="w-full min-h-screen flex flex-col justify-between p-4 md:p-12 bg-transparent z-10">
      ...
      {/* Bottom Menu & Mobile Socials Box */}
      <div className="w-full flex flex-col gap-2 md:max-w-4xl md:mx-auto">
        <div className="w-full bg-zinc-950/40 backdrop-blur-md border-t border-white/10 pt-4 pb-5 md:pb-4 md:border md:rounded-2xl">
